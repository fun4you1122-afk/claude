...
export function CTABanner() {
  ...
  return (
    <section className="relative py-24 overflow-hidden">
      <div className="absolute inset-0" style={{ background: "linear-gradient(135deg, hsl(222,47%,8%) 0%, hsl(222,47%,5%) 50%, hsl(222,47%,8%) 100%)" }} />
      ...
      <div className="relative mx-auto max-w-4xl px-6 md:px-8 text-center">
        ...
        >
          ...
          <h2 className="font-serif text-4xl font-bold leading-tight md:text-5xl lg:text-6xl mb-6">
            {t.cta.h1}{" "}
            <span className="gold-gradient">{t.cta.h2}</span>
          </h2>
