...
function WaFab() {
  return (
    <a
      ...
      aria-label="WhatsApp WeThink"
      className="group fixed bottom-7 right-7 z-50 flex h-14 w-14 items-center justify-center rounded-full bg-emerald-500 text-white shadow-[0_4px_20px_rgba(52,211,153,0.5)] transition-all hover:scale-110"
    >
